...
public class AddDeleteContact {
	...
	static String first = "Kenny";
	static String last = "McCormick";
	static String email = "kenny@southparkelementary.edu";
	static String phoneType = "mobile";
	static String phone = "719-555-4444";
	static String company = "Mysterion";
	static String jobTitle = "Protector";
	static String address = "1 Main Street";
	static String city = "South Park";
	static String state = "CO";
	static String zip = "80813";
	static String country = "USA";
	static String source = "referral";
	static String status = "new";
	static String type = "prospect";
	static String tag = "VIP";
	static String twitter = "@kennyhumor";
	...
	public static void setUp() throws Exception {
		log4j = Logger.getLogger(AddDeleteContact.class.getName());
	...
	public void newContact() throws Exception {
		...
		driver.findElement(By.cssSelector(selector)).click();
		util.snooze(z);
		selector = ".dialog-button-right.button-warning";
		Assert.assertTrue(util.isVisible(selector));	
		driver.findElement(By.cssSelector(selector)).click();
		util.snooze(z);
	    
		//need an assert that we're now back to the list view and deleted contact is gone
